...
namespace read_d2c_messages
{
    public class ReadDeviceToCloudMessages
    {
        ...
        // az iot hub show --query properties.eventHubEndpoints.events.endpoint --name esms-mqtt-iot-hub
        private const string EventHubsCompatibleEndpoint = "sb://iothub-ns-esms-mqtt-5101584-e587627b26.servicebus.windows.net/";

        // Event Hub-compatible name
        // az iot hub show --query properties.eventHubEndpoints.events.path --name esms-mqtt-iot-hub
        private const string EventHubName = "esms-mqtt-iot-hub";

        // az iot hub policy show --name service --query primaryKey --hub-name esms-mqtt-iot-hub
        private const string IotHubSasKeyName = "service";
        private const string IotHubSasKey = "UoDchoLFFfTASR7WR3MCpglDhV0nMu74HxUGamqU+HA=";
